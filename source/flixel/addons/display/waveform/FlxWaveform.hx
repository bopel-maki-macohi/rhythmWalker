...
class FlxWaveform extends FlxSprite
{
	 ...
	 */
	public function new(?x:Float = 0, ?y:Float = 0, width:Int, height:Int, ?color:FlxColor = 0xFFFFFFFF, ?backgroundColor:FlxColor = 0x00000000,
			?drawMode:WaveformDrawMode = COMBINED)
	{
		super(x, y);
